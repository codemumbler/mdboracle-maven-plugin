...
@Mojo(name = "data-conversion", defaultPhase = LifecyclePhase.GENERATE_RESOURCES)
public class DataConverterMojo
		extends AbstractMojo {

	@Parameter(defaultValue = "${project.basedir}/src/main/resources/db/migration/V1_1__data_transfer_from_mdb.sql")
